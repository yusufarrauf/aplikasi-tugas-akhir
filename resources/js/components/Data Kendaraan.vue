                        ...
                        <table id="table" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                <tr v-for="(da, index) in kendaraan" :key="da.id">
                                    ...
                                    <td class="text-center">{{ da.nopol }}</td>
                    ...
                    <form @submit.prevent="editmode ? edit() : insert()" @keydown="form.onKeydown($event)">
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <input v-model="form.nopol" type="text" name="nopol" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <select v-model="form.jenis" id="jenis" name="jenis" class="form-control"
...
<script>
    export default {
        ...
        methods: {
            ...
            insert() {
                this.$Progress.start();
                this.form.post('/api/data_kendaraan')
                    .then(() => {
            ...
            edit() {
                this.$Progress.start();
                this.form.put('/api/data_kendaraan/' + this.form.id)
                    .then(() => {
                        Fire.$emit('reloadData');
                        $('#modal').modal('hide')
                        Toast.fire({
            ...
            deleteData(da) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.form.delete('/api/data_kendaraan/' + da.id).then(() => {
                            Swal.fire(
                                'Terhapus!',
        ...
        mounted() {
            document.title = documentTitle + 'Data Kendaraan';
